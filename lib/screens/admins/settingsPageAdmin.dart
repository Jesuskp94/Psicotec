...
class SettingsPageAdmin extends StatefulWidget {
  @override
  _SettingsPageAdmin createState() => _SettingsPageAdmin();
}

class _SettingsPageAdmin extends State<SettingsPageAdmin> with WidgetsBindingObserver {
  ...
  void _select(Choice choice)
  {
    switch (choice.title)
    {
      ...
      case 'Contract':
        ...
        Navigator.pushReplacementNamed(context, 'contractPageAdmintLeft');
        break;
      case 'Results':
        print('has pulsado en el botón de los resultados');
        Navigator.pushReplacementNamed(context, 'resultsPageAdminLeft');
        break;
      case 'Settings':
